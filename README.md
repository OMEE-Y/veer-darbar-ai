...
* **Conversational AI:** Engage with distinct historical personalities, each with their own unique style, history, and strategic insights.
* **Blazing Speed:** Powered by the Groq API, ensuring responses are instantaneous.
* **Cultural Authenticity:** Focused on the rich heritage, bravery, and tactical genius of Indian warriors.
* **Interactive Storytelling:** A platform designed for roleplay and learning from the legends themselves.
